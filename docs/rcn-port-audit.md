...
| All-PRs page | `render_all_prs` src/pr_ui.rs:388+, composed at src/main.rs:5647-5649 | same inset-mirror of `terminal_area` | drag/scroll of PR lists handled in tree; canvas still resolves ribbon/panel |
...
the sidebar — the Sessions/PR empty-state CTA+hint (src/renderer.rs:604-636), which is
